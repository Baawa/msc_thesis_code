...
data_icp = np.genfromtxt("results_icp_with_resampling_time.txt", delimiter="\t")
data_mcp = np.genfromtxt("results_mcp_with_resampling_time.txt", delimiter="\t")
data_mcp_nd = np.genfromtxt("results_node_degree_mcp_with_resampling_time.txt", delimiter="\t")
data_ndw = np.genfromtxt("results_node_degree_weighted_cp_with_resampling_time.txt", delimiter="\t")
data_ew = np.genfromtxt("results_embedding_weighted_cp_with_resampling_time.txt", delimiter="\t")
...
plot(1, "Prediction latency (ms) - OGB Arxiv - with resampling", "Latency", ymin=0, ymax=30)