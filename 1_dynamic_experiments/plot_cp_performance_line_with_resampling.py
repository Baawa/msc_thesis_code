...
data_icp = np.genfromtxt("results_icp_with_resampling_performance.txt", delimiter="\t")
data_mcp = np.genfromtxt("results_mcp_with_resampling_performance.txt", delimiter="\t")
data_mcp_nd = np.genfromtxt("results_node_degree_mcp_with_resampling_performance.txt", delimiter="\t")
data_ndw = np.genfromtxt("results_node_degree_weighted_cp_with_resampling_performance.txt", delimiter="\t")
data_ew = np.genfromtxt("results_embedding_weighted_cp_with_resampling_performance.txt", delimiter="\t")
...
plot(1, "Coverage - OGB Arxiv - with resampling", "Coverage", ymin=0.9, ymax=1, plot_confidence_level=True)
plot(3, "Average Prediction Set Size - OGB Arxiv - with resampling", "Average prediction set size", ymin=0, ymax=30)
plot(5, "Singleton Predictions - OGB Arxiv - with resampling", "Fraction of singleton predictions", ymin=0, ymax=0.4)
plot(6, "Empty Predictions - OGB Arxiv - with resampling", "Fraction of empty predictions", ymin=0, ymax=0.05)