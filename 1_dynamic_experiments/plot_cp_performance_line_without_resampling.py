...
plot(1, "Coverage - OGB Arxiv", "Coverage", ymin=0.7, ymax=1, plot_confidence_level=True)
plot(3, "Average Prediction Set Size - OGB Arxiv", "Average prediction set size", ymin=4, ymax=15)
plot(5, "Singleton Predictions - OGB Arxiv", "Fraction of singleton predictions", ymin=0, ymax=0.4)
plot(6, "Empty Predictions - OGB Arxiv", "Fraction of empty predictions", ymin=0, ymax=0.05)